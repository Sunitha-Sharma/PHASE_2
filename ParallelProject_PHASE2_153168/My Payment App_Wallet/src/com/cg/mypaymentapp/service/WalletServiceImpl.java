...
public class WalletServiceImpl implements WalletService {
	...
	public Customer showBalance(String mobileNo) {
		...
		if (customer != null)
			...
			throw new InvalidInputException("Mobile no is Invalid ");
	}
	...
	public Customer fundTransfer(String sourceMobileNo, String targetMobileNo,
		...
		if (repo.findOne(sourceMobileNo) == null) {
			throw new InvalidInputException("Source mobile number is not valid ");
		} else if (repo.findOne(targetMobileNo) == null) {
			throw new InvalidInputException("Target mobile number is not valid");
		} else {
